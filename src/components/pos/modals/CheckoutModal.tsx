        ...
        >
          ...
          >
            ...
            <View className="flex-row gap-4">
              <View className="flex-1 gap-1.5">
                <Text className="text-sm font-semibold text-foreground">
                  Jenis pesanan <Text className="text-danger">*</Text>
                </Text>
                <Select
              ...
              <View className="flex-1 gap-1.5">
                <View className="flex-row justify-between">
                  <Text className="text-sm font-semibold text-foreground">Meja</Text>
                  <Text className="text-xs text-muted-foreground">Opsional</Text>
                </View>
                <Select
            ...
            <View className="gap-2">
              <Text className="text-sm font-semibold text-foreground">Metode</Text>
            ...
            <View className="gap-2">
              <Text className="text-sm font-semibold text-foreground">
                Pembayaran <Text className="text-danger">*</Text>
              </Text>
              {errors.payment_id && (
                <Text className="text-xs text-danger">{errors.payment_id.message}</Text>
              )}
            ...
            {/* Customer */}
            <View className="gap-2">
              <Text className="text-sm font-semibold text-foreground">Pelanggan</Text>
              <View className="flex-row gap-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <View className="gap-1">
                      ...
                      <Text className="text-xs text-primary">Cari berdasarkan nama</Text>
                    </View>
                  )}
                />
              )}
            ...
            <View className="border border-border rounded-xl overflow-hidden">
              <View className="flex-row justify-between px-4 py-3 border-b border-border">
                ...
                <Text className="text-sm text-foreground">{formatRupiah(subtotal)}</Text>
              </View>
              {paymentFee > 0 && (
                <View className="flex-row justify-between px-4 py-3 border-b border-border">
                  ...
                  <Text className="text-sm text-foreground">{formatRupiah(paymentFee)}</Text>
                </View>
              )}
