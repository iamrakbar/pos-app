...
terms: any[] | string | null;
products?: App.Data.Customer.Product.ProductData[];
...
group_type: string;
group_label: string;
payments: App.Data.Customer.Payment.PaymentData[];
};
}
...
required: boolean;
multiple: boolean;
options: App.Data.Customer.Product.OptionData[];
};
...
image: any[] | null;
category: any[] | null;
add_ons: App.Data.Customer.Product.AddOnData[];
is_active: boolean;
is_po: boolean;
po_availability: any[] | null;
};
}
...
best_sellers: { product_id: string; name: string; qty_sold: number; revenue: number }[];
};
}
declare namespace App.Data.Merchant.Delivery {
export type DeliveryDetailData = {
waybill_id: string | null;
tracking_status: any[] | null;
...
subtotal: number;
tax: any[] | null;
delivery_fee: any[] | null;
payment_fee: any[] | null;
