...
/**
 * Discord clyde logo icon - monochrome React Native SVG implementation.
 * Wrapped with withUniwind to enable className-based styling.
 */
const DiscordIconComponent = ({
  size = 20,
  color = 'currentColor'
}) => {
...
/**
 * Monochrome Discord icon wrapped with withUniwind for className-based styling
 *
 * @example
 * ```tsx
 * <DiscordIcon colorClassName="accent-foreground" />
 * <DiscordIcon size={24} color="#000" />
 * ```
 */
export const DiscordIcon = withUniwind(DiscordIconComponent, {
  color: {
