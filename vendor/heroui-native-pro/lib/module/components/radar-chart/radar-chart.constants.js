...
export const DISPLAY_NAME = {
  ROOT: 'HeroUINative.RadarChart.Root',
  GRID: 'HeroUINative.RadarChart.Grid',
  ANGLE_AXIS: 'HeroUINative.RadarChart.AngleAxis',
  RADIUS_AXIS: 'HeroUINative.RadarChart.RadiusAxis',
  RADAR: 'HeroUINative.RadarChart.Radar'
};
 ...
 */
export const DEFAULT_NUM_TICKS = 5;
 ...
 */
export const DEFAULT_RADIUS_PADDING = 0.78;
 ...
 */
export const DEFAULT_LABEL_RADIUS_OFFSET = 1.05;
 ...
 */
export const DEFAULT_GRID_STROKE_ALPHA = 0.3;
 ...
 */
export const DEFAULT_RADAR_STROKE_WIDTH = 2;
 ...
 * typography.
 */
export const DEFAULT_FONT_FAMILY = Platform.select({
  ios: 'Helvetica',
  default: 'sans-serif'
});
 ...
 */
export const DEFAULT_RADIUS_AXIS_ANGLE = 0;
 ...
 */
export const DEFAULT_RADIUS_AXIS_ORIENTATION = 'right';
 ...
 */
export const DEFAULT_RADIUS_AXIS_INCLUDE_ZERO = false;