import type { FlatList, Pressable, Text, View, ViewStyle } from 'react-native';
/**
...
/**
 * Reference type for React Native FlatList with numeric items
 * Used for forwarding refs to FlatList elements
 */
type FlatListRef = FlatList<number>;
/**
...
export type { ComponentPropsWithAsChild, FlatListRef, ForceMountable, Insets, PositionedContentProps, PressableRef, SlottablePressableProps, SlottableTextProps, SlottableViewProps, TextRef, ViewRef, };
