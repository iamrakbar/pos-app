 ...
 */
export declare function FullWindowOverlay({ disableFullWindowOverlay, unstable_accessibilityContainerViewIsModal, children, }: FullWindowOverlayProps): import("react/jsx-runtime").JSX.Element;
